...
/**
 * Class that represents the Rectangle Shape
 */
public class Rectangle extends Square {
    ...
    public String toString() {
        return "Rectangle: x=" + upLeft.getXcoordinate() + "; y=" + upLeft.getYcoordinate() + "; height=" + side + "; " +
                "width=" + width + "; edge color=" + getColor().toString().substring(14).replace('=',
                '-') + "; area color=" +
    ...
    public void selected(Graphics graphics) {
        ...
        new Line(getUpLeft(), new Point(upLeft.getXcoordinate() + super.side, upLeft.getYcoordinate()))
                .selected(graphics);
        new Line(getUpLeft(), new Point(upLeft.getXcoordinate(), upLeft.getYcoordinate() + width))
                .selected(graphics);
