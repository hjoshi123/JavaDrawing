...
public class Square extends SShape {
    ...
    public String toString() {
        return "Square: x=" + upLeft.getXcoordinate() + "; y=" + upLeft.getYcoordinate() + "; side=" +
                side + "; edge color=" + getColor().toString().substring(14).replace('=', '-') +
    ...
    public void selected(Graphics graphics) {
        ...
        new Line(getUpLeft(), new Point(upLeft.getXcoordinate() + side, upLeft.getYcoordinate()))
                .selected(graphics);
        new Line(upLeft, new Point(upLeft.getXcoordinate(), upLeft.getYcoordinate() + side))
                .selected(graphics);
        new Line(new Point(upLeft.getXcoordinate() + side, upLeft.getYcoordinate()), diagonal().getLast())
                .selected(graphics);
        new Line(new Point(upLeft.getXcoordinate(), upLeft.getYcoordinate() + side), diagonal().getLast())
                .selected(graphics);
    }
    ...
    public void fillUpShape(Graphics graphics) {
        ...
        graphics.fillRect(upLeft.getXcoordinate() + 1, upLeft.getYcoordinate() + 1, side - 1,
                side - 1);
    }
    ...
    public Line diagonal() {
        return new Line(upLeft, new Point(upLeft.getXcoordinate() + side,
                upLeft.getYcoordinate() + side));
    }
