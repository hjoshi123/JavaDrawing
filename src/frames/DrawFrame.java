 ...
 * Template GUI class from Internet
 */
public class DrawFrame extends JFrame {
    ...
    public DrawFrame() {
        ...
        tglBtnDrawPoint = new JToggleButton(new ImageIcon(DrawFrame.class.getResource("/icons/point.png")));
        ...
        tglBtnDrawPoint.setCursor(toolkit.createCustomCursor(selectCursor ,
                new java.awt.Point(tglBtnDrawPoint.getX(), tglBtnDrawPoint.getY()), "img"));
        buttonsPanelForDrawing.add(tglBtnDrawPoint);

        tglBtnDrawSquare = new JToggleButton(new ImageIcon(DrawFrame.class.getResource("/icons/square.png")));
        tglBtnDrawSquare.setFont(new Font("Dotum", Font.BOLD, 12));
        tglBtnDrawSquare.setText("Square");
        buttonsGroup.add(tglBtnDrawSquare);
        tglBtnDrawSquare.setCursor(toolkit.createCustomCursor(selectCursor ,
                new java.awt.Point(tglBtnDrawSquare.getX(), tglBtnDrawSquare.getY()), "img"));
        buttonsPanelForDrawing.add(tglBtnDrawSquare);

        tglBtnDrawRectangle = new JToggleButton(new ImageIcon(DrawFrame.class.getResource("/icons/rectangle.png")));
        ...
        tglBtnDrawRectangle.setCursor(toolkit.createCustomCursor(selectCursor,
                new java.awt.Point(tglBtnDrawSquare.getX(), tglBtnDrawSquare.getY()), "img"));
        buttonsPanelForDrawing.add(tglBtnDrawRectangle);

        tglBtnDrawLine = new JToggleButton(new ImageIcon(DrawFrame.class.getResource("/icons/line.png")));
        tglBtnDrawLine.setFont(new Font("Dotum", Font.BOLD, 12));
        tglBtnDrawLine.setText("Line");
        buttonsGroup.add(tglBtnDrawLine);
        tglBtnDrawLine.setCursor(toolkit.createCustomCursor(selectCursor,
                new java.awt.Point(tglBtnDrawSquare.getX(), tglBtnDrawSquare.getY()), "img"));
        buttonsPanelForDrawing.add(tglBtnDrawLine);

        tglBtnDrawCircle = new JToggleButton(new ImageIcon(DrawFrame.class.getResource("/icons/circle.png")));
        tglBtnDrawCircle.setFont(new Font("Dotum", Font.BOLD, 12));
        tglBtnDrawCircle.setText("Circle");
        buttonsGroup.add(tglBtnDrawCircle);
        tglBtnDrawCircle.setCursor(toolkit.createCustomCursor(selectCursor,
                new java.awt.Point(tglBtnDrawSquare.getX(), tglBtnDrawSquare.getY()), "img"));
        buttonsPanelForDrawing.add(tglBtnDrawCircle);

        tglBtnDrawHexagon = new JToggleButton(new ImageIcon(DrawFrame.class.getResource("/icons/hexagon.png")));
        tglBtnDrawHexagon.setFont(new Font("Dotum", Font.BOLD, 12));
        tglBtnDrawHexagon.setText("Hexagon");
        buttonsGroup.add(tglBtnDrawHexagon);
        tglBtnDrawHexagon.setCursor(toolkit.createCustomCursor(selectCursor,
                new java.awt.Point(tglBtnDrawSquare.getX(), tglBtnDrawSquare.getY()), "img"));
        buttonsPanelForDrawing.add(tglBtnDrawHexagon);

        btnSaveDraw = new JButton(new ImageIcon(DrawFrame.class.getResource("/icons/save.png")));
        btnSaveDraw.setEnabled(false);
        btnSaveDraw.setText("Save");
        btnSaveDraw.setCursor(toolkit.createCustomCursor(selectCursor,
                new java.awt.Point(tglBtnDrawSquare.getX(), tglBtnDrawSquare.getY()), "img"));
        buttonsPanelForDrawing.add(btnSaveDraw);

        btnNewDraw = new JButton(new ImageIcon(DrawFrame.class.getResource("/icons/new.png")));
        btnNewDraw.setText("New draw");
        btnNewDraw.setEnabled(false);
        btnNewDraw.setCursor(toolkit.createCustomCursor(selectCursor,
                new java.awt.Point(tglBtnDrawSquare.getX(), tglBtnDrawSquare.getY()), "img"));
        btnNewDraw.setEnabled(false);
        buttonsPanelForDrawing.add(btnNewDraw);

        JButton btnOpenDraw = new JButton(new ImageIcon(DrawFrame.class.getResource("/icons/open.png")));
        btnOpenDraw.setText("Open");
        btnOpenDraw.setCursor(toolkit.createCustomCursor(selectCursor,
                new java.awt.Point(tglBtnDrawSquare.getX(), tglBtnDrawSquare.getY()), "img"));
        buttonsPanelForDrawing.add(btnOpenDraw);

        btnLog = new JButton(new ImageIcon(DrawFrame.class.getResource("/icons/log.png")));
        btnLog.setEnabled(false);
        btnLog.setText("Log");
        btnLog.setFont(new Font("Lucida Console", Font.BOLD, 12));
        btnLog.setCursor(toolkit.createCustomCursor(selectCursor,
                new java.awt.Point(tglBtnDrawSquare.getX(), tglBtnDrawSquare.getY()), "img"));
        buttonsPanelForDrawing.add(btnLog);

        tglBtnSelect = new JToggleButton(new ImageIcon(DrawFrame.class.getResource("/icons/select.png")));
        tglBtnSelect.setText("Select");
        tglBtnSelect.setEnabled(false);
        buttonsGroup.add(tglBtnSelect);
        tglBtnSelect.setCursor(toolkit.createCustomCursor(selectCursor,
                new java.awt.Point(tglBtnDrawSquare.getX(), tglBtnDrawSquare.getY()), "img"));
        buttonsPanel.add(tglBtnSelect);

        btnUpdate = new JButton(new ImageIcon(DrawFrame.class.getResource("/icons/update.png")));
        btnUpdate.setText("Update");
        btnUpdate.setEnabled(false);
        buttonsGroup.add(btnUpdate);
        btnUpdate.setCursor(toolkit.createCustomCursor(selectCursor,
                new java.awt.Point(tglBtnDrawSquare.getX(), tglBtnDrawSquare.getY()), "img"));
        buttonsPanel.add(btnUpdate);

        btnDelete = new JButton(new ImageIcon(DrawFrame.class.getResource("/icons/delete.png")));
        btnDelete.setText("Delete");
        btnDelete.setEnabled(false);
        buttonsGroup.add(btnDelete);
        btnDelete.setCursor(toolkit.createCustomCursor(selectCursor,
                new java.awt.Point(tglBtnDrawSquare.getX(), tglBtnDrawSquare.getY()), "img"));
        ...
        btnEdgeColor = new JButton(new ImageIcon(DrawFrame.class.getResource("/icons/picker.png")));
        btnEdgeColor.setForeground(Color.WHITE);
        btnEdgeColor.setText("Edge color");
        btnEdgeColor.setBackground(Color.BLACK);
        btnEdgeColor.setCursor(toolkit.createCustomCursor(selectCursor , new java.awt.Point(tglBtnDrawSquare.getX(),
                tglBtnDrawSquare.getY()), "img"));
        btnEdgeColor.addMouseListener(mouseAdapterEdgeColor);
        buttonsPanel.add(btnEdgeColor);

        btnInteriorColor = new JButton(new ImageIcon(DrawFrame.class.getResource("/icons/color-picker.png")));
        btnInteriorColor.setText("Area color");
        btnInteriorColor.setForeground(Color.BLACK);
        btnInteriorColor.setBackground(Color.WHITE);
        btnInteriorColor.setCursor(toolkit.createCustomCursor(selectCursor , new java.awt.Point(tglBtnDrawSquare.getX(),
                tglBtnDrawSquare.getY()), "img"));
        btnInteriorColor.addMouseListener(mouseAdapterInteriorColor);
        buttonsPanel.add(btnInteriorColor);

        btnUndo = new JButton(new ImageIcon(DrawFrame.class.getResource("/icons/undo.png")));
        btnUndo.setEnabled(false);
        btnUndo.setCursor(toolkit.createCustomCursor(selectCursor , new java.awt.Point(tglBtnDrawSquare.getX(),
                tglBtnDrawSquare.getY()), "img"));
        buttonsPanel.add(btnUndo);

        btnRedo = new JButton(new ImageIcon(DrawFrame.class.getResource("/icons/redo.png")));
        btnRedo.setEnabled(false);
        btnRedo.setCursor(toolkit.createCustomCursor(selectCursor , new java.awt.Point(tglBtnDrawSquare.getX(), 
                tglBtnDrawSquare.getY()), "img"));
        buttonsPanel.add(btnRedo);

        btnToFront = new JButton(new ImageIcon(DrawFrame.class.getResource("/icons/to-front.png")));
        btnToFront.setText("To front");
        btnToFront.setEnabled(false);
        btnToFront.setFont(new Font("Lucida Console", Font.BOLD, 11));
        btnToFront.setCursor(toolkit.createCustomCursor(selectCursor , new java.awt.Point(tglBtnDrawSquare.getX(), 
                tglBtnDrawSquare.getY()), "img"));
        buttonsPanel.add(btnToFront);

        btnToBack = new JButton(new ImageIcon(DrawFrame.class.getResource("/icons/to-back.png")));
        btnToBack.setText("To back");
        btnToBack.setFont(new Font("Lucida Console", Font.BOLD, 11));
        btnToBack.setEnabled(false);
        btnToBack.setCursor(toolkit.createCustomCursor(selectCursor , new java.awt.Point(tglBtnDrawSquare.getX(), 
                tglBtnDrawSquare.getY()), "img"));
        buttonsPanel.add(btnToBack);

        btnBringToFront = new JButton(new ImageIcon(DrawFrame.class.getResource("/icons/bring-to-front.png")));
        btnBringToFront.setText("Bring to front");
        btnBringToFront.setEnabled(false);
        btnBringToFront.setFont(new Font("Lucida Console", Font.BOLD, 11));
        btnBringToFront.setCursor(toolkit.createCustomCursor(selectCursor , new java.awt.Point(tglBtnDrawSquare.getX(), 
                tglBtnDrawSquare.getY()), "img"));
        buttonsPanel.add(btnBringToFront);

        btnBringToBack = new JButton(new ImageIcon(DrawFrame.class.getResource("/icons/bring-to-back.png")));
        btnBringToBack.setText("Bring to back");
        btnBringToBack.setEnabled(false);
        btnBringToBack.setFont(new Font("Lucida Console", Font.BOLD, 11));
        btnBringToBack.setCursor(toolkit.createCustomCursor(selectCursor , new java.awt.Point(tglBtnDrawSquare.getX(), 
                tglBtnDrawSquare.getY()), "img"));
        ...
        mouseAdapterLog = new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent click) {
                if (btnLog.getText().equals("Log")) {
                    ...
                    btnLog.setText("Draw");
                    btnLog.setIcon(new ImageIcon(DrawFrame.class.getResource("/icons/draw.png")));

                } else if (btnLog.getText().equals("Draw")) {
                    mainPanel.remove(scrollPane);
                    mainPanel.add(view, BorderLayout.CENTER);
                    btnLog.setText("Log");
                    btnLog.setIcon(new ImageIcon(DrawFrame.class.getResource("/icons/log.png")));
                }
