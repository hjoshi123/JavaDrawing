...
public class DlgCircle extends JDialog {
    ...
    public DlgCircle() {
        ...
        btnEdgeColor.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent click) {
                ...
                if (edgeColor != null) {
					if (edgeColor.equals(Color.WHITE)) JOptionPane.showMessageDialog(null,
                            "Background is white :D");
					else {
            ...
            getContentPane().add(buttonsPanel, BorderLayout.SOUTH);
            {
                ...
                btnConfirm.addActionListener(new ActionListener() {
                    public void actionPerformed(ActionEvent click) {
                        if (txtXcoordinateOfCenter.getText().isEmpty() || txtYcoordinateOfCenter.getText().isEmpty() ||
                                txtRadiusLength.getText().isEmpty())
                            ...
                            try {
                                ...
                                if (xCoordinateOfCenter <= 0 || yCoordinateOfCenter <= 0 || radiusLength <= 0)
                                    JOptionPane.showMessageDialog(getParent(),
                                            "X and Y coordinates of center and radius length of " +
                                                    "circle must be positive numbers!",
                                            "Error", JOptionPane.ERROR_MESSAGE);
                                else if (radiusLength + xCoordinateOfCenter > drawWidth ||
                                        radiusLength + yCoordinateOfCenter > drawHeight ||
                                        yCoordinateOfCenter - radiusLength <= 0 ||
                                        xCoordinateOfCenter - radiusLength < 0)
                                    JOptionPane.showMessageDialog(null,
                                            "The circle goes out of drawing!");
                        		else {
                        			confirmed = true;
                        			setVisible(false);
                        			dispose();          
                                ...
                                JOptionPane.showMessageDialog(getParent(),
                                        "X and Y coordinates of center and radius length of circle must be whole numbers!",
                                        "Error", JOptionPane.ERROR_MESSAGE);
                            }
                        }
                    }
	 ...
	 * 
	 * @param xOfClick Represent x coordinate of clicked place.
	 * @param yOfClick Represent y coordinate of clicked place
	 ...
	 * 
	 * @param circle Represent {@link Circle} that user want to update.
     * @param drawHeight Represents the height of JFrame
     * @param drawWidth Represents the width of JFrame
	 */
